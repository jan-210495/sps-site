...
(function() {
  ...
  const i18n = {
    en: {
      ...
      'footer.cta': 'Support',
      'footer.cta.body': 'Help fuel camps, instruments, and outreach for Damascus youth.',
      'footer.cta.button': 'Support a project',
      ...
      'gallery.featured1.caption': 'Good Friday fire tableau',
      'gallery.featured2.caption': 'Scouts marching on Good Friday',
      'gallery.featured3.caption': 'Cubs learn first aid',
      'gallery.featured4.caption': 'Rovers train with White Helmets',
      'gallery.featured5.caption': 'Band animates Easter',
      'gallery.featured6.caption': 'Visit from partner troop',
      ...
      'news.post3.meta': 'Oct 21, 2025',
      'news.post4.meta': 'Sep 5, 2025',
      'news.post4.title': 'White Helmets safety training',
      'news.post4.body': 'Beavers, Cubs, and parents learned family-ready emergency tips inside our courtyard.',
      'news.readmore': 'Read more',
      'news.cta.title': 'Share a story or invite coverage',
      'news.cta.body': 'Send photos, testimonies, or collaboration ideas to our media team so we can celebrate Damascus together.',
      'news.cta.button': 'Contact media team',
      // Not found
    ...
    ar: {
      ...
      'footer.cta': 'ادعموا الخدمة',
      'footer.cta.body': 'ساهموا في تمويل المخيمات والآلات والمبادرات للشبيبة في دمشق.',
      'footer.cta.button': 'ادعم مبادرة',
      ...
      'gallery.featured1.caption': 'لوحة النار في الجمعة العظيمة',
      'gallery.featured2.caption': 'مسيرة الجمعة العظيمة',
      'gallery.featured3.caption': 'الأشبال يتعلمون الإسعاف',
      'gallery.featured4.caption': 'الجوالة مع الخوذ البيضاء',
      'gallery.featured5.caption': 'الفرقة تنعش الفصح',
      'gallery.featured6.caption': 'زيارة فوج صديق',
      ...
      'news.post1.meta': '30 تشرين الثاني 2025',
      ...
      'news.post2.meta': '12 تشرين الثاني 2025',
      ...
      'news.post3.meta': '21 تشرين الأول 2025',
      'news.post4.meta': '5 أيلول 2025',
      'news.post4.title': 'تدريب سلامة مع الخوذ البيضاء',
      'news.post4.body': 'تعلّم القنادس والأشبال وذووهم نصائح طوارئ منزلية داخل باحتنا.',
      'news.readmore': 'اقرأ المزيد',
      'news.cta.title': 'شاركونا قصة أو طلب تغطية',
      'news.cta.body': 'أرسلوا صورًا أو شهادات أو أفكار تعاون إلى فريق الإعلام لنحتفل معًا بدمشق.',
      'news.cta.button': 'تواصل مع فريق الإعلام',
      // Not found
